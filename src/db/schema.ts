...
export const channels = iptvchannels.table("channels", {
...
export const series = iptvchannels.table("series", {
  id: uuid("id").primaryKey().defaultRandom(),
...
export const media = iptvchannels.table(
  "media",
  {
    id: uuid("id").primaryKey().defaultRandom(),
